...
from typing import Generator, NoReturn, Optional, Protocol
...
class Cache(Protocol):
    ...
    def get_arrow_dataset(self, stream_name: str, max_chunk_size: int = 100000) -> pa.Table: ...
...
class ReadResult(Protocol):
    ...
    def to_arrow(self, stream_name: str, max_chunk_size: int = 100000) -> pa.Table: ...
